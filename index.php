        ...
        <div class="aboutus py-5">
            ...
            <div class="row justify-content-center mx-0">
                <div class="col-md-4 col-lg-2 text-center">
                    <img class="img-fluid logodeer align-self-center mr-3"
                         src="https://image.noelshack.com/fichiers/2019/10/1/1551715431-cerfsansfond.png"
                         alt="logo wild"/>
                </div>
                <div class="col-md-8 col-lg-6 text-left mx-3">
                    <h5 class="mt-0">Our story...</h5>
                    <p class="text">
                        The Wild Baazar is a project made by our students from the Wild Code School in order to fund
                        non-profit
                        associations. Indeed, the Wild Code School think that Education success can be eased when we
                        have good
                        stuff like computers. Therefore, for each sold object by the Wild Baazar, a part of the revenues
                        will be
                        donated to associations in order to fund computers for children who have not easily access to
                        education or
...
<!--     <script src="assets/js/secretgifs.js"></script>-->
</body>
