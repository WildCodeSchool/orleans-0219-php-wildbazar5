...
<body>
    ...
    <div class="container p-0">
        ...
        <section class="dr_section_color">
            ...
            <div class="row p-2">
                    ...
                    <?php include 'tableaufig.php';
              foreach ($typeAndAnswer as $key => $value) {?>

                    <div class="col-md-6 col-lg-4 col-xl-3">
                            <article>
                                <div class="card border-dark my-4 dr_card" data-toggle="modal" data-target="<?= '#' . $key ?>">
                                <div class="dr_wrapper text-center ">
                                        <img src="<?= $value['URLimg']?>"
                                            class="card-img-top img-fluid art-image" alt="Produit 4">
                                </div>
                                <div class="card-img-overlay">
                                    <div class="card-body text-right p-1">
                                            <h3><span class="card-text badge badge-info dr_badge"><?= $value['Value'] ?> $</span></h3>
                                    </div>
                                </div>
                                <div class="card-body">
    ...
    <div class="modal fade" id=<?= $key ?> tabindex="-1" role="dialog" aria-labelledby="modalDescrProduct"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row no-gutters">
                        <div class="col-xs-6 col-md-4 art-img-content">
                            <img class="card-img art-img" src="<?= $value['URLimg']?>" alt="Card image" />
                        </div>
                        <div class=" col-xs-6 col-md-8">
                            <div class="card-body">
                                <h4><span class="art-price"><?= $value['Value'] ?> $</span></h4>
                                <p class="card-text art-descr"><?= $value['Description'] ?></p>
                                <table class="table table-striped table-sm">
                                    <tbody>
                                        <tr>
                                          <th scope="row">Height</th>
                                          <td><span><?= $value['Height'] ?> Inch</span></td>
                                        </tr>
                                        <tr>
                                          <th scope="row">Weight</th>
                                          <td><span><?= $value['Weight'] ?> Lbs</span></td>
                                        </tr>
                                        <tr>
