        ...
        <div class="row justify-content-center">
            ...
            <div class="col-6 col-md-4">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control" id="short_Title" placeholder="Enter the card title"
                           name="short_title" value="<?= $_POST['short_title'] ?? '' ?>" required>
            ...
            <div class="col-12">
                <div class="form-group ">
                    ...
                    <textarea class="form-control" id="summary" rows="4" name="summary"
                              required><?= $_POST['summary'] ?? '' ?></textarea>
                </div>
                <p><?= $errors['summary'] ?? '' ?></p>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="picture" placeholder="Enter the image's path"
                           name="picture" value="<?= $_POST['picture'] ?? '' ?>" required>
                </div>
                <p><?= $errors['picture'] ?? '' ?></p>
            </div>
            ...
            <div class="col-6 ">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="color" placeholder="Enter the product's color"
                           name="color" value="<?= $_POST['color'] ?? '' ?>" required>
                </div>
                <p><?= $errors['color'] ?? '' ?></p>
            </div>
            ...
            <div class="col-6 ">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="reference" placeholder="Enter the product's reference"
                           name="reference" value="<?= $_POST['reference'] ?? '' ?>" required>
                </div>
